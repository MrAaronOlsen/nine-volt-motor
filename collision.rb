class Collision
	...
	attr_accessor :face
	attr_reader :query, :type, :direction, :side_of_face, :penetration,
                :c, :face_dot, :face_norm, :face_normal_dot,   
                :check_part, :check_part_half_width, :check_body, :check_body_v,
                :against_part, :against_part_half_width, :against_part_points,
				:against_body, :against_body_v
